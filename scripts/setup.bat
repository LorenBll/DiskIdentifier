...
REM Set up DiskIdentifier on Windows.

echo.
echo DiskIdentifier - Windows Setup
echo.
...
if not exist "resources\configuration.json" (
  echo WARNING: Create resources\configuration.json before running DiskIdentifier.
) else (
...
echo.
echo ===============================================
echo   DiskIdentifier Setup Complete
echo ===============================================
echo.
